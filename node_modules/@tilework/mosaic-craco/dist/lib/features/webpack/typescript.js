...
function disableTypeChecking(webpackConfig) {
    var _a;
    webpackConfig.plugins = (_a = webpackConfig.plugins) === null || _a === void 0 ? void 0 : _a.filter(function (plugin) { return (plugin === null || plugin === void 0 ? void 0 : plugin.constructor.name) !== 'ForkTsCheckerWebpackPlugin'; });
